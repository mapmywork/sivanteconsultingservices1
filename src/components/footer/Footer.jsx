        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-12">
          <div>
            ...
            <div className="flex space-x-4">
              ...
              <a href="https://share.google/Bo94odD6e9HBj4sMi" target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-full bg-white/5 flex items-center justify-center text-gray-400 hover:bg-primary hover:text-[#0A0A0A] transition-all">
                <Google size={20} />
              </a>
            </div>
          </div>
