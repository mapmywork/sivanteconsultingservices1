          ...
          <div className="lg:col-span-1 space-y-8">
            ...
            <div className="pt-6 border-t border-white/10 mt-6">
              ...
              <div className="flex space-x-4">
                ...
                <a href="https://share.google/Bo94odD6e9HBj4sMi" target="_blank" rel="noopener noreferrer" className="w-12 h-12 bg-white/5 rounded-full flex items-center justify-center text-white hover:bg-primary hover:text-[#0A0A0A] transition-colors">
                  <Google size={24} />
                </a>
              </div>
            </div>
