    ...
    <section id="ecosystem" className="py-24 bg-background">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          ...
          <h2 className="text-4xl md:text-5xl font-playfair font-bold text-secondary">A Synergistic Portfolio</h2>
        </div>
        ...
        <div className="flex flex-col md:flex-row justify-center items-center gap-8 relative">
          ...
          {entities.map((entity, idx) => (
            ...
            >
              ...
              <h3 className="text-xl font-bold text-secondary mb-2">{entity.name}</h3>
